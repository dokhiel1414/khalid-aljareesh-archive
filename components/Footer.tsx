...
export default function Footer() {
  ...
  return (
    <footer className="relative mt-20 border-t border-ink/10 dark:border-dark-border bg-ink dark:bg-dark-bg text-sand/90 overflow-hidden">
      <div className="absolute inset-0 pattern-geo opacity-[0.06]" aria-hidden />
      <div className="container py-10 grid gap-8 md:grid-cols-2 relative">
        <div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-sand/80">
            ...
            <li><Link href="/groups" className="hover:text-gold">مجموعات التواصل</Link></li>
      ...
      <div className="border-t border-sand/10 relative">
